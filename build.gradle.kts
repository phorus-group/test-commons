...
dependencies {
    ...
    api("org.junit.platform:junit-platform-suite:1.11.0")
    api("io.cucumber:cucumber-java:7.18.1")
    api("io.cucumber:cucumber-junit-platform-engine:7.18.1")
    api("io.cucumber:cucumber-spring:7.18.1")
    api("junit:junit")
}
